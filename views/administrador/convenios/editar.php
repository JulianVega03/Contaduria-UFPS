            ...
            <div class="calender-area mg-b-15">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <h3>EDITAR Información del Convenio</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <table class="table" style="width: 100%">
                                                ...
                                                <tbody>
                                                    <form action="<?= constant('URL') ?>convenios/actualizarEstudiante/<?=$this->convenio->id?>" method="post">
                                                        <tr>
                                                            <th scope="row">Primer Nombre</th>
                                                            <td scope="col"> <input type="text" name="p_nombre" value="<?= $estudiante->p_nombre ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Segundo Nombre</th>
                                                            <td scope="col"> <input type="text" name="s_nombre" value="<?= $estudiante->s_nombre ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Primer Apellido</th>
                                                            <td scope="col"> <input type="text" name="p_apellido" value="<?= $estudiante->p_apellido ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Segundo Apellido</th>
                                                            <td scope="col"> <input type="text" name="s_apellido" value="<?= $estudiante->s_apellido ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Codigo</th>
                                                            <td scope="col"> <input type="text" name="codigo" value="<?= $estudiante->codigo ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Tipo Documento</th>
                                                            <td scope="col"> <input type="text" name="tipo_identificacion" value="<?= $estudiante->tipo_identificacion ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Numero de Documento</th>
                                                            <td scope="col"> <input type="number" name="identificacion" value="<?= $estudiante->identificacion ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Fecha de Expedición</th>
                                                            <td scope="col"> <input type="date" name="fecha_expedicion" value="<?= $estudiante->fecha_expedicion ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Genero</th>
                                                            <td scope="col"> <input type="text" name="genero" value="<?= $estudiante->genero ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Fecha de Nacimiento</th>
                                                            <td scope="col"> <input type="date" name="fecha_nacimiento" value="<?= $estudiante->fecha_nacimiento ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Semestre</th>
                                                            <td scope="col"> <input type="text" name="semestre" value="<?= $estudiante->semestre ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Departamento</th>
                                                            <td scope="col"> <input type="text" name="dpto" value="<?= $estudiante->dpto ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Ciudad</th>
                                                            <td scope="col"> <input type="text" name="ciudad" value="<?= $estudiante->ciudad ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Correo Electronico</th>
                                                            <td scope="col"> <input type="email" name="email" value="<?= $estudiante->email ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Dirección</th>
                                                            <td scope="col"> <input type="text" name="direccion" value="<?= $estudiante->direccion ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Telefono Fijo</th>
                                                            <td scope="col"> <input type="text" name="telf_fijo" value="<?= $estudiante->telf_fijo ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Telefono Celular</th>
                                                            <td scope="col"> <input type="text" name="telf_movil" value="<?= $estudiante->telf_movil ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th><input type="number" name="id_estudiante" class="hidden" value="<?= $estudiante->id ?>" readonly></th>
                                                            <td scope="col"> <input type="submit" class="btn btn-primary" value="Actualizar"> </td>
                                                        </tr>
                                                    </form>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <table class="table " style="width: 100%">
                                                ...
                                                ?>
                                                <tbody>
                                                    <form action="<?= constant('URL') ?>convenios/actualizarEmpresa/<?=$this->convenio->id?>" method="post">
                                                        <tr>
                                                            <th scope="row">Nombre</th>
                                                            <td scope="col"> <input type="text" name="nombre" value="<?= $empresa->nombre ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Nit</th>
                                                            <td scope="col"> <input type="text" name="nit" value="<?= $empresa->nit ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Email</th>
                                                            <td scope="col"> <input type="email" name="email" value="<?= $empresa->email ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Telefono</th>
                                                            <td scope="col"> <input type="text" name="telefono" value="<?= $empresa->telefono ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Dirección</th>
                                                            <td scope="col"> <input type="text" name="direccion" value="<?= $empresa->direccion ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Tipo Empresa</th>
                                                            <td scope="col"> <input type="text" name="tipo_empresa" value="<?= $empresa->tipo_empresa ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Naturaleza Juridica</th>
                                                            <td scope="col"> <input type="text" name="naturaleza_juridica" value="<?= $empresa->naturaleza_juridica ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Actividad Economica</th>
                                                            <td scope="col"> <input type="text" name="actividad_economica" value="<?= $empresa->actividad_economica ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><span class="red">Representante Legal:</span> Nombres</th>
                                                            <td scope="col"> <input type="text" name="r_legal_nombres" value="<?= $empresa->r_legal_nombres ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><span class="red">Representante Legal:</span> Apellidos</th>
                                                            <td scope="col"> <input type="text" name="r_legal_apellidos" value="<?= $empresa->r_legal_apellidos ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><span class="red">Representante Legal:</span> Identificación</th>
                                                            <td scope="col"> <input type="text" name="r_legal_identificacion" value="<?= $empresa->r_legal_identificacion ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><span class="red">Representante Legal:</span> Lugar de Expedición ID </th>
                                                            <td scope="col"> <input type="text" name="r_legal_lugar_exp_id" value="<?= $empresa->r_legal_lugar_exp_id ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><span class="blue">Supervisor:</span> Nombres</th>
                                                            <td scope="col"> <input type="text" name="superv_nombres" value="<?= $empresa->superv_nombres ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><span class="blue">Supervisor:</span> Apellidos</th>
                                                            <td scope="col"> <input type="text" name="superv_apellidos" value="<?= $empresa->superv_apellidos ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><span class="blue">Supervisor:</span> Identificación</th>
                                                            <td scope="col"> <input type="text" name="superv_identificacion" value="<?= $empresa->superv_identificacion ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><span class="blue">Supervisor:</span> Lugar de Expedición ID</th>
                                                            <td scope="col"> <input type="text" name="superv_lugar_exp_id" value="<?= $empresa->superv_lugar_exp_id ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row"><span class="blue">Supervisor:</span> Cargo</th>
                                                            <td scope="col"> <input type="text" name="supervisor_cargo" value="<?= $empresa->supervisor_cargo ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th><input type="number" name="id_empresa" class="hidden" value="<?= $empresa->id ?>" readonly></th>
                                                            <td scope="col"> <input type="submit" class="btn btn-primary" value="Actualizar"> </td>
                                                        </tr>
                                                    </form>
                                                </tbody>
                                            ...
                                            <table class="table " style="width: 100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td scope="col"><input type="text" name="" value="<?= $this->convenio->tipo_trabajo_grado == null ? "PRACTICAS" : "TRABAJO DE GRADO"; ?>" readonly> </td>
                                                    </tr>
                                                    <?php
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="" value="<?= $this->convenio->tipo_trabajo_grado ?>"> </td>
                                                        </tr>
                                                    <?php
                                                    } else {
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="" value="<?= $practica->asignatura ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Docente</th>
                                                            <td><input type="text" name="" value="<?= $practica->docente ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Docente Email</th>
                                                            <td><input type="text" name="" value="<?= $practica->docenteEmail ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Jornada</th>
                                                            <td><input type="text" name="" value="<?= $practica->jornada ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Grupo</th>
                                                            <td><input type="text" name="" value="<?= $practica->grupo ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Area Designada</th>
                                                            <td><input type="text" name="" value="<?= $practica->areaDesignada ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Tematica a Desarrollar</th>
                                                            <td><input type="text" name="" value="<?= $practica->tematicaDesarrollar ?>"> </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Horario Asistencia</th>
                                                            <td><input type="text" name="" value="<?= $practica->horarioAsistencia ?>"> </td>
                                                        </tr>
