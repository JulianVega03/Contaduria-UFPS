    ...
    header("Content-Disposition: attachment; filename=pdf");
     ...
     <div class="contenedor">
          ...
          <p id="enunciado">
            ...
            a fin de proceder a realizar LA PRACTICA DE LA MATERIA <?=$materia?>, coordinada por el profesor(a) <?=$profesor?>,
          ...
          <table>
            ...
            <tr>
              <th>Temática a desarrollar</th>     <td> <?=$tematica?> <br> </td>
            </tr>
            <tr>
            ...
            <tr>
              <th>Horario de Asistencia:</th>     <td><br><br><?=$horario_asistencia?><br></td>
            </tr>
          </table>
          <br>
          <p id="constancia">
