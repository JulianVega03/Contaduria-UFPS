...
<body>
    ...
    $_POST['f1-empresa-direccion'])) {
        ...
        $tipo_empresa = strtoupper($_POST['f1-tipo-empresa']);
        $naturaleza_juridica = strtoupper($_POST['f1-naturaleza-juridica']);
        $actividad_economica = strtoupper($_POST['f1-actividad-economica']);
    }
    ...
    if (isset($_POST['f1-tipo-grado']) && $_POST['f1-tipo-grado'] != "nulo") {
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="1" style="width:14px; text-align:center">
                <?php
        ...
        <tr>
            ...
            <td colspan="3">CP<?=$_POST['f1-consecutivo']?></td>
        </tr>
